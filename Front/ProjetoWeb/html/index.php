...
curl_setopt($ch, CURLOPT_URL, 'http://127.0.0.1:5000/categories');
    ...
    echo '
      <li>
        <a href="#" class="category-box">
          <img src="assets/images/top-category/'.$item["name_cat"].'.png" class="img-fluid" alt="">
          <h4>'.$item["name_cat"].'</h4>
        </a>
      </li>
      ';
...
curl_setopt($ch, CURLOPT_URL, 'http://34.130.177.142:5000/demands');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
